...
function _load_IosUtils() {
  return _IosUtils = _interopRequireWildcard(require('./IosUtils'));
}
...
function createIPABuilder(buildParams) {
  let build = (() => {
    var _ref = _asyncToGenerator(function* () {
      ...
      const codeSignIdentity = yield (_IosUtils || _load_IosUtils()).ensureCertificateValid(buildParams);
      logger.info('ensured certificate is valid');

      logger.info('writing export-options.plist file...');
      const exportMethod = (_IosUtils || _load_IosUtils()).resolveExportMethod(plistData);
      ...
      yield (_IosUtils || _load_IosUtils()).writeExportOptionsPlistFile(exportOptionsPlistPath, exportOptionsData);
      ...
      yield (_IosUtils || _load_IosUtils()).buildIPA(ipaBuilderArgs, buildParams, clientBuild);
      ...
      yield (_IosUtils || _load_IosUtils()).createEntitlementsFile({
      ...
      yield (_IosUtils || _load_IosUtils()).resignIPA({
        codeSignIdentity,
