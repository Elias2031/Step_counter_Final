...
var action = function () {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)( /*#__PURE__*/(_regenerator || _load_regenerator()).default.mark(function _callee(projectDir, options) {
    var projectState, root, startOpts, devToolsUrl, _ref2, url, isUrlFallback, _ref3, exp, recipient, devToolsEnabled, _ref4;
    ...
    return (_regenerator || _load_regenerator()).default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 45:
            _context.next = 47;
            return (_xdl || _load_xdl()).UserSettings.getAsync('devToolsEnabled', null);

          case 47:
            devToolsEnabled = _context.sent;
            ...
            (_log || _load_log()).default.nested((_chalk || _load_chalk()).default.bold('Expo can display a browser UI to help you work on your project.'));
            _context.next = 52;
          ...
          case 52:
            _ref4 = _context.sent;
            devToolsEnabled = _ref4.devToolsEnabled;
            _context.next = 56;
            return (_xdl || _load_xdl()).UserSettings.setAsync('devToolsEnabled', devToolsEnabled);

          case 56:
            (0, (_log || _load_log()).default)('Expo DevTools running at ' + devToolsUrl);
            if (devToolsEnabled) {
              (0, (_opn || _load_opn()).default)(devToolsUrl);
            }
