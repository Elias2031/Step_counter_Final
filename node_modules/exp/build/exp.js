...
function _load_codeFrame() {
  return _codeFrame = require('@babel/code-frame');
}
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 13:
              ...
              packagerLogsStream = new (_xdl || _load_xdl()).PackagerLogsStream({
                ...
                getSnippetForError: function getSnippetForError(error) {
                  if (!error.filename || !error.lineNumber || !error.column) {
                    return null;
                  }
                  var rawLines = _fs.default.readFileSync(error.filename, 'utf8');
                  var location = { start: { line: error.lineNumber, column: error.column + 1 } };
                  return (0, (_codeFrame || _load_codeFrame()).codeFrameColumns)(rawLines, location, {
                    highlightCode: true
                  });
                }
              });
